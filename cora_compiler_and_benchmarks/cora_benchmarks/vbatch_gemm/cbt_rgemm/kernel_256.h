...
__device__ void gemm_256_64x64(int M, int N, int K, float *A, float *B, float *C, int block_base_y, int block_base_x, float *sh){
  ...
  reg_C[0] = make_float4(0, 0, 0, 0);
  reg_C[1] = make_float4(0, 0, 0, 0);
  reg_C[2] = make_float4(0, 0, 0, 0);
  reg_C[3] = make_float4(0, 0, 0, 0);
...
__device__ void gemm_256_128x64(int M, int N, int K, float *A, float *B, float *C, int block_base_y, int block_base_x, float *sh){
  ...
  reg_C[2] = make_float4(0, 0, 0, 0);
  reg_C[3] = make_float4(0, 0, 0, 0);
  reg_C[4] = make_float4(0, 0, 0, 0);
  reg_C[5] = make_float4(0, 0, 0, 0);
  reg_C[6] = make_float4(0, 0, 0, 0);
  reg_C[7] = make_float4(0, 0, 0, 0);
...
__device__ void gemm_256_128x128(int M, int N, int K, float *A, float *B, float *C, int block_base_y, int block_base_x, float *sh){
  ...
  reg_C[6] = make_float4(0, 0, 0, 0);
  reg_C[7] = make_float4(0, 0, 0, 0);
  reg_C[8] = make_float4(0, 0, 0, 0);
  reg_C[9] = make_float4(0, 0, 0, 0);
  reg_C[10] = make_float4(0, 0, 0, 0);
  reg_C[11] = make_float4(0, 0, 0, 0);
  reg_C[12] = make_float4(0, 0, 0, 0);
  reg_C[13] = make_float4(0, 0, 0, 0);
  reg_C[14] = make_float4(0, 0, 0, 0);
  reg_C[15] = make_float4(0, 0, 0, 0);
