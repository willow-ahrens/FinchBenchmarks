...
public:
  ...
  static ModeFormat rlep;          /// e.g., variable block
  ...
  static ModeFormat RLEP;          /// alias for variable block
...
extern const ModeFormat RLE_size(int size);
