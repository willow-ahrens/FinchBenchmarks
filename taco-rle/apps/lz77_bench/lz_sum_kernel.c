...
int compute(taco_tensor_t *expected_, taco_tensor_t *T1, taco_tensor_t *T1001) {
  ...
  while (iT1_pos < pT11_end && iT1001_pos < pT10011_end) {
    ...
    if (((iT1_crd == i_crd && iT1001_crd == i_crd) && T11_found_cnt) && T10011_found_cnt) {
      ...
      for (int32_t l = 0; l < for_end; l++) {
        ...
        ((uint8_t*)&(((uint8_t*)expected__vals)[iexpected__pos]))[0] = 0.500000 * ((uint8_t*)&(((uint8_t*)T1_vals)[iT1_pos]))[0] + 0.500000 * ((uint8_t*)&(((uint8_t*)T1001_vals)[iT1001_pos]))[0];
