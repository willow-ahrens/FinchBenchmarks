...
function spmv_eigen(y, A, x)
	...
	eigen_path = "/data/scratch/changwan/Finch_oopsla_v3/FinchBenchmarks/deps/eigen-3.4.0"
	withenv("PATH" => "$eigen_path", "EIGEN_CFLAGS" => "-O3 -ffast-math -std=c99 -march=native -ggdb") do
	  spmv_path = "/data/scratch/changwan/Finch_oopsla_v3/FinchBenchmarks/spmv/spmv_eigen"
