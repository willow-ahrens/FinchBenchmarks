...
ModeFormat ModeFormat::RLEP(std::make_shared<RLEModeFormat>());
...
ModeFormat ModeFormat::rlep = ModeFormat::RLEP;
...
const ModeFormat RLEP = ModeFormat::RLEP;
...
const ModeFormat RLE_size(int size){
  return ModeFormat(std::make_shared<CompressedModeFormat>(false, true, true, false, true, size));
}
