...
public:
  ...
  /// @{
  bool compute(taco_tensor_t*& a0, taco_tensor_t*& a1, taco_tensor_t*& a2, taco_tensor_t*& a3, taco_tensor_t*& a4) const;
  bool compute(taco_tensor_t*& a0, taco_tensor_t*& a1, taco_tensor_t*& a2, taco_tensor_t*& a3) const;
  bool compute(taco_tensor_t*& a0, taco_tensor_t*& a1, taco_tensor_t*& a2) const;
  bool compute(taco_tensor_t*& a0, taco_tensor_t*& a1) const;
  ...
  void unpack(size_t numResults, const std::vector<void*> arguments,
    const std::vector<TensorStorage>& args);
